...
@IBDesignable open class YokoTextField: TextFieldEffects {
     ...
     */
    @IBInspectable dynamic open var foregroundColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) {
        didSet {
            updateForeground()
        }
    }
    ...
    fileprivate func rectForBorder(_ bounds: CGRect, isFilled: Bool) -> CGRect {
        ...
        if CATransform3DIsIdentity(foregroundView.layer.transform).isFalse {
